...
const std::vector<TextureBinding>& RenderGraphContext::GetPassTextureSlots() const
{
	static const std::vector<TextureBinding> empty;
	return m_PassBindings ? *m_PassBindings : empty;
}
